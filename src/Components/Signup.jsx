...
function Signup() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between bg-[#0b0c10] text-slate-100 font-sans p-4 sm:p-6 lg:p-8 relative overflow-hidden dot-pattern">
      ...
      <div className="absolute -bottom-32 right-1/4 w-[500px] h-[300px] glow-orb rounded-full filter blur-[120px] pointer-events-none"></div>
      ...
      {/* Center Auth Card */}
      <main className="w-full max-w-[480px] mx-auto my-auto z-10 py-6">
        <div className="bg-[#13151f] border border-[#232636] rounded-2xl p-6 sm:p-9 shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl font-serif text-white tracking-tight mb-2">
              Create an account on <span className="gradient-text">Utalk</span>
            </h1>
            <p className="text-xs text-slate-400 font-sans leading-relaxed">
              Join thousands connecting with real-time messages, HD calls, and instant syncing.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="font-mono text-[10px] font-semibold text-slate-500 uppercase tracking-widest">or register with email</span>
            <div className="flex-1 border-t border-[#232636]"></div>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-3.5">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="John"
                  required
                  className="w-full h-10 px-3 bg-[#181a26] border border-[#2a2e42] text-white text-sm rounded-xl focus:border-[#0052FF] focus:ring-2 focus:ring-[#0052FF]/30 outline-none transition-all placeholder-slate-500 font-medium"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full h-10 px-3.5 bg-[#181a26] border border-[#2a2e42] text-white text-sm rounded-xl focus:border-[#0052FF] focus:ring-2 focus:ring-[#0052FF]/30 outline-none transition-all placeholder-slate-500 font-medium"
              />
            </div>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full h-10 px-3 pr-8 bg-[#181a26] border border-[#2a2e42] text-white text-sm rounded-xl focus:border-[#0052FF] focus:ring-2 focus:ring-[#0052FF]/30 outline-none transition-all placeholder-slate-500 font-medium"
                  />
                  <button
                    type="button"
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              <label htmlFor="terms" className="text-xs text-slate-300 cursor-pointer select-none">
                I agree to the <a href="#" className="text-[#4D7CFF] hover:underline">Terms of Service</a> & <a href="#" className="text-[#4D7CFF] hover:underline">Privacy Policy</a>
              </label>
            </div>
            ...
            >
              {loading ? (
                ...
                <>
                  <span>Create Utalk Account</span>
